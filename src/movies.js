...
const movies = Immutable.List([
  { title: "Close Encounters of the Third Kind", released: 1977, directors: [5], categories: [1, 0] },
  { title: "Gangs of New York", released: 2002, directors: [10], categories: [3, 1] },
  { title: "Prince of Darkness", released: 1987, directors: [41], categories: [5, 8] },
  { title: "The Blues Brothers", released: 1980, directors: [84], categories: [4, 2, 3, 9] },
  { title: "RED", released: 2010, directors: [130], categories: [4, 2, 3, 5] },
  { title: "21 Grams", released: 2003, directors: [128], categories: [3, 1, 5] },
  { title: "Idiocracy", released: 2006, directors: [40], categories: [6, 2, 0] },
  { title: "Escape from New York", released: 1981, directors: [41], categories: [4, 0] },
  { title: "Clerks", released: 1994, directors: [21], categories: [2] },
  { title: "Death Race", released: 2008, directors: [31], categories: [4, 0, 5] },
  { title: "Spies Like Us", released: 1985, directors: [84], categories: [6, 2] },
  { title: "¡Three Amigos!", released: 1986, image: "Three_Amigos.jpg", directors: [84], categories: [2, 7] },
  { title: "Alien", released: 1979, directors: [0], categories: [8, 0] },
  { title: "A.I. Artificial Intelligence", released: 2001, directors: [5], categories: [6, 1, 0] },
  { title: "Catch Me If You Can", released: 2002, directors: [5], categories: [14, 3, 1] },
  { title: "Minority Report", released: 2002, directors: [5], categories: [4, 6, 3, 1, 14, 0, 5] },
  { title: "Teenage Mutant Ninja Turtles", released: 1990, directors: [38], categories: [4, 6, 2, 15, 0] },
  { title: "Electric Dreams", released: 1984, directors: [38], categories: [2, 1, 9] },
  { title: "Zero Dark Thirty", released: 2012, directors: [12], categories: [1, 13, 5] },
  { title: "The Cable Guy", released: 1996, directors: [27], categories: [2, 1, 5] },
  { title: "O Brother Where Art Thou?", image: "O_Brother_Where_Art_Thou.jpg", released: 2000, directors: [3], categories: [6, 2, 3, 9] },
  { title: "El Mariachi", released: 1992, directors: [8], categories: [4, 5] },
  { title: "Kick-Ass", released: 2010, directors: [17], categories: [4, 2] },
  { title: "Dead Poets Scociety", released: 1989, directors: [104], categories: [2, 1] },
  { title: "Twister", released: 1996, directors: [42], categories: [4, 6, 1, 5] },
  { title: "Warm Bodies", released: 2013, directors: [131], categories: [2, 8, 12] },
  { title: "The Breakfast Club", released: 1985, directors: [22], categories: [2, 1] },
  { title: "50 First Dates", released: 2004, directors: [43], categories: [2, 12] },
  { title: "Tommy Boy", released: 1995, directors: [43], categories: [6, 2] },
  { title: "Billy Madison", released: 1995, directors: [44], categories: [2] },
  { title: "12 Monkeys", released: 1995, directors: [2], categories: [14, 0, 5] },
  { title: "Monty Python and the Holy Grail", released: 1975, directors: [2, 129], categories: [6, 2, 10] },
  { title: "Toy Story", released: 1995, directors: [45], categories: [11, 6, 2, 15, 10] },
  { title: "The Lawnmower Man", released: 1992, directors: [46], categories: [6, 0] },
  { title: "Encino Man", released: 1992, directors: [47], categories: [2] },
  { title: "White Men Can't Jump", released: 1992, directors: [11], categories: [2, 1, 16] },
  ...
  { title: "The Lego Movie", released: 2014, directors: [55, 56], categories: [11, 4, 6] },
  { title: "21 Jump Street", released: 2012, directors: [55, 56], categories: [4, 2, 3] },
  ...
  { title: "Wonder Woman", released: 2017, directors: [112], categories: [4, 6, 10] },
  { title: "Logan", released: 2017, directors: [105], categories: [4, 1, 0] },
  ...
  { title: "Edge of Tomorrow", released: 2014, directors: [28], categories: [4, 6, 0] },
  ...
  { title: "Her", released: 2013, directors: [73], categories: [1, 12, 0] },
  ...
  { title: "Event Horizon", released: 1997, directors: [31], categories: [8, 0, 5] },
