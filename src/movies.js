...
const movies = Immutable.List([
  { title: "Close Encounters of the Third Kind", released: 1977, directors: [5] },
  { title: "Gangs of New York", released: 2002, directors: [10] },
  { title: "Idiocracy", released: 2006, directors: [40] },
  { title: "Escape from New York", released: 1981, directors: [41] },
  { title: "Clerks", released: 1994, directors: [21] },
  { title: "Death Race", released: 2008, directors: [31] },
  { title: "Spies Like Us", released: 1985, directors: [84] },
  { title: "¡Three Amigos!", released: 1986, image: "Three_Amigos.jpg", directors: [84] },
  { title: "Alien", released: 1979, directors: [0] },
  { title: "A.I. Artificial Intelligence", released: 2001, directors: [5] },
  { title: "Catch Me If You Can", released: 2002, directors: [5] },
  { title: "Minority Report", released: 2002, directors: [5] },
  { title: "Teenage Mutant Ninja Turtles", released: 1990, directors: [38] },
  { title: "Electric Dreams", released: 1984, directors: [38] },
  ...
  { title: "RobinHood Men in Tights", released: 1993, directors: [68] },
