...
const movies = Immutable.List([
  ...
  { title: "RED", released: 2010, directors: [130], categories: [4, 2, 3] },
  ...
  { title: "Dead Poets Scociety", released: 1989, directors: [104] },
  ...
  { title: "Monty Python and the Holy Grail", released: 1975, directors: [2, 129] },
